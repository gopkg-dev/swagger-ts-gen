...
- Model split: one type per .ts file plus model/index.ts exports.
- Model bundling override: always generate a single model/index.ts even if >500 lines (user confirmed).
